  ...
  return (
    <div className="bg-primary/60 h-full">
      <div className="w-full h-full bg-gradient-to-r from-primary/10 via-black/30 to-black/10 pt-[90px]">
        <div className="text-center flex flex-col justify-center xl:pt-10 xl:text-left h-full container mx-auto px-4">
          <motion.h1 
...
>
  ...
  animate="show"
  exit="hidden"
  className="flex justify-center xl:justify-start -mt-16 xl:mt- z-50 relative"
>
  <ProjectsBtn />
</motion.div>
