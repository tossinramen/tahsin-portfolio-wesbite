    ...
    <section id="about" className="min-h-screen">
      <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
        ...
        <motion.div
          ...
          animate="show"
          exit="hidden"
          className="hidden xl:flex absolute -bottom-40 -left-[370px]"
        >
          <Avatar />
        </motion.div>
        ...
        <div className="container mx-auto h-full flex flex-col items-center justify-center text-center xl:text-left">
          {/* Tab Navigation */}
          <div className="flex gap-x-4 xl:gap-x-8 mx-auto xl:mx-0 mb-6 mt-20">
                ...
                {item.icons && (
                  <div className="flex flex-wrap gap-3 mt-2 justify-center xl:justify-start">
                    {item.icons.map((iconData, iconIndex) => (
                      ...
                      key={iconIndex}
                      title={iconData.name}
                      className="text-3xl transition-transform hover:scale-110 cursor-default"
                    >
                      {iconData.icon}
                    </span>
                    ))}
